 ...
 */
public class SwipeHelper2 {
    static final String TAG = SwipeHelper2.class.getSimpleName();
    ...
    public SwipeHelper2(Context context, int swipeDirection, SwipeHelperCallback callback, float densityScale,
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.d(TAG, "ACTION_DOWN - " + mCurrView);
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d(TAG, "ACTION_MOVE - " + mCurrView);
                if (mCurrView != null) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.d(TAG, "onTouchEvent - " + mDragging + " " + mProtected);
/*        if (!mDragging || mProtected) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d(TAG, "onTouchEvent - ACTION_MOVE " + mCurrView);
                if (mCurrView != null) {
            ...
            case MotionEvent.ACTION_UP:
            case MotionEvent.ACTION_CANCEL:
                Log.d(TAG, "onTouchEvent - ACTION_CANCEL " + mCurrView);
                if (mCurrView != null) {
                    ...
                    Log.d(TAG, "dismiss Child - " + dismissChild);
                    if (dismissChild) {
